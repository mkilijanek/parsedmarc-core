...
def _mailparser_parse_from_string(data: str):
    ...
    This is a mail-parser bug, not a parsedmarc one — see fork #30 /
    upstream domainaware/parsedmarc#808 — and this helper can be removed
    once mail-parser guards the call itself."""
    try:
